...
- `evaluation/plot_mice_lick.py`
- `training/train_mice_lick.py`
- `training/train_core.py`
- `models/motif_mamba.py`

## Result Set

Selected seeds in `results/bmi_decoding/mice_lick`:
...
Default: `data/mice_lick/M2_segmented_data`

Override with: `FIG5_MICE_LICK_DATA_ROOT=/path/to/M2_segmented_data`

Cache:

Default: `data/mice_lick_m2_window_cache`
...
- `results/bmi_decoding/mice_lick.png`
- `results/bmi_decoding/mice_lick.pdf`
- `results/bmi_decoding/mice_lick.svg`
- `results/bmi_decoding/mice_lick_values.csv`
- `results/bmi_decoding/mice_lick_stats.csv`
