...
FIGURES_ROOT = PROJECT_ROOT / "results" / "reinforcement_learning" / "figures"
...
def main() -> None:
    if not RAW_RESULTS_ROOT.is_dir():
        raise FileNotFoundError(
            f"Missing prepared result directory: {RAW_RESULTS_ROOT}. Run scripts/prepare_rl_data.py first."
        )
