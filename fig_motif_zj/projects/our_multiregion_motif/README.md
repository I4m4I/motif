# our_multiregion_motif

多脑区 motif 分析项目（whole-brain / region-level）。

## 目录
- `notebooks/fig1_new_region.ipynb`
- `notebooks/figs6.ipynb`
- `notebooks/heatmap.ipynb`
- `notebooks/soma_distribution.ipynb`
- `notebooks/supp_fig.ipynb`
...
2. 打开 `projects/our_multiregion_motif/notebooks/` 下对应 notebook
