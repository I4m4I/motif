...
PLOT_JOBS = (
    PlotJob(
        name="Jango",
        script=ROOT / "evaluation" / "plot_jango.py",
        result_root=ROOT / "results" / "bmi_decoding" / "jango",
        out_file=ROOT / "results" / "bmi_decoding" / "jango.png",
    ),
    PlotJob(
        name="Calcium Action",
        script=ROOT / "evaluation" / "plot_calcium.py",
        result_root=ROOT / "results" / "bmi_decoding" / "calcium",
        out_file=ROOT / "results" / "bmi_decoding" / "calcium_action.png",
    ),
    PlotJob(
        name="mice lick",
        script=ROOT / "evaluation" / "plot_mice_lick.py",
        result_root=ROOT / "results" / "bmi_decoding" / "mice_lick",
        out_file=ROOT / "results" / "bmi_decoding" / "mice_lick.png",
    ),
)
