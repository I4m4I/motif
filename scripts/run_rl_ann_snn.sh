...
"${PLOT_PYTHON}" scripts/prepare_rl_data.py

echo "[2/2] Regenerating clean figures..."
"${PLOT_PYTHON}" evaluation/plot_rl_suite.py

echo
echo "Done."
echo "Figures: ${SCRIPT_DIR}/../results/reinforcement_learning/figures"
echo "Manifest: ${SCRIPT_DIR}/../results/reinforcement_learning/results_manifest.json"
