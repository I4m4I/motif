"""Figure 3 training entry point for motif-regularized recurrent PPO."""
...
from models.rl.motif_rl import *
import configparser
sys.stdout.flush()
...
parser.add_argument('--env',type=str, default="ip")
parser.add_argument('--diagBool', type=lambda x: (str(x).lower() == 'true'), default=True)
...
cfg_list.read(os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir, 'configs', 'rl_params.ini'), encoding='utf-8')
